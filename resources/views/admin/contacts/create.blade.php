<x-layout>
    <x-slot:title>Tambahkan Kontak</x-slot:title>

    <div class="max-w-2xl mx-auto py-6">
        <h2 class="text-2xl font-bold text-white mb-6">Tambah Informasi Kontak Baru</h2>
        ...
        <form action="{{ route('admin.contacts.store') }}" method="POST" class="bg-gray-800 rounded-lg p-6">
            ...
            <div class="mb-4">
                <label class="block text-white mb-2 font-medium">Pilih Sosmed *</label>
                ...
                <p class="text-gray-400 text-sm mt-1">Pilih Paltform Sosmed</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="label" value="{{ old('label') }}" required
                    ...
                    class="w-full bg-gray-700 text-white rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                <p class="text-gray-400 text-sm mt-1">Menampilkan Nama dari Kontak</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="value" value="{{ old('value') }}" required
                    ...
                    class="w-full bg-gray-700 text-white rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                <p class="text-gray-400 text-sm mt-1">Nomor HP Atau Username Instagram</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="order" value="{{ old('order', 0) }}"
                    placeholder="0"
                    class="w-full bg-gray-700 text-white rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                <p class="text-gray-400 text-sm mt-1">Angka Kecil = Diurutkan Paling Atas (0 = Paling Atas)</p>
            </div>
            ...
            <div class="mb-6">
                <label class="flex items-center text-white">
                    ...
                    Aktif (Ditampilkan di Menu Kontak)
                </label>
            </div>
