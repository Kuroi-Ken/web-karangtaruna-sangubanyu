<x-layout>
    ...
    <div class="max-w-4xl mx-auto py-4 sm:py-6 px-4 sm:px-0">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="text-xl sm:text-2xl font-bold text-white">Edit Post</h2>
        </div>
        ...
        <form action="{{ route('admin.posts.update', $post) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <div id="imagePreview" class="mt-4 hidden">
                    <p class="text-gray-400 text-sm mb-2">New Image Preview:</p>
                    <div class="relative inline-block">
            ...
            <div class="p-4 bg-gray-700/50 rounded-lg space-y-2">
                <div class="text-gray-400 text-sm">
                    <span class="font-semibold text-white">Created by:</span> 
                    {{ $post->author->name ?? 'System' }}
                </div>
                <div class="flex flex-col sm:flex-row sm:gap-4 gap-1 text-xs text-gray-500">
                    <div>
                        <span class="font-semibold text-gray-400">Created:</span> 
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <button type="button" 
                        onclick="if(confirm('Are you sure you want to delete this post?')) document.getElementById('delete-form').submit()"
