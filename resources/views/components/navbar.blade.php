        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6 gap-3">
                    @guest
                        <a href="{{ route('login') }}" 
                           class="rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700 transition shadow-lg hover:shadow-indigo-500/50">
                            Admin Login
                        </a>
                    @else
                        <div class="flex items-center gap-3 bg-gray-700/50 rounded-lg px-4 py-2">
                            <div class="flex items-center gap-2">
                                <div class="size-8 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-sm">
                                    A
                                </div>
    ...
    <el-disclosure id="mobile-menu" hidden class="md:hidden [&:not([hidden])]:block">
        ...
        <div class="border-t border-white/10 pb-3 pt-4">
            @guest
                <div class="px-2">
                    <a href="{{ route('login') }}"
                       class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-base font-semibold text-white hover:bg-indigo-700 shadow-lg">
                        Admin Login
                    </a>
                </div>
            @else
                <div class="flex items-center px-5 mb-3">
                    <div class="shrink-0">
                        <div class="size-10 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold">
                            A
                        </div>
                    </div>
                    <div class="ml-3">
